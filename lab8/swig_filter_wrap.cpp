...
SWIGINTERN PyObject *_wrap_Delay_process(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Delay_process", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_Delay, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Delay_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Delay_get", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_Delay, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_delete_Delay(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_Delay, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Filter_setCoef(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Filter_setCoef", 2, 2, swig_obj)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_FilterChain_setCoef(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FilterChain *arg1 = (FilterChain *) 0 ;
  double *arg2 = (double *) 0 ;
  std::size_t arg3 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "FilterChain_setCoef", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_FilterChain, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "FilterChain_setCoef" "', argument " "1"" of type '" "FilterChain *""'"); 
  }
  arg1 = reinterpret_cast< FilterChain * >(argp1);
  {
    npy_intp size[2] = {
  ...
  (arg1)->setCoef((double const *)arg2,arg3,arg4);
  resultobj = SWIG_Py_Void();
  {
    if (is_new_object2 && array2)
    {
...
SWIGINTERN PyObject *_wrap_delete_FilterChain(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_FilterChain, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *FilterChain_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}

static PyMethodDef SwigMethods[] = {
	 { "SWIG_PyInstanceMethod_New", SWIG_PyInstanceMethod_New, METH_O, NULL},
	 { "new_Delay", _wrap_new_Delay, METH_O, NULL},
	 { "Delay_process", _wrap_Delay_process, METH_VARARGS, NULL},
	 { "Delay_reset", _wrap_Delay_reset, METH_O, NULL},
	 { "Delay_get", _wrap_Delay_get, METH_VARARGS, NULL},
	 { "Delay_printArray", _wrap_Delay_printArray, METH_O, NULL},
